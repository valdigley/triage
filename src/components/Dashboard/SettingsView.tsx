          ...
          <div className="space-y-6">
            ...
            {settings.watermark_enabled && (
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Texto da Marca d'água (fallback)
                  </label>
                  <input
                    type="text"
                    ...
                    placeholder="Preview"
                  />
                  <p className="text-xs text-gray-500 mt-1">Usado quando não há imagem PNG configurada</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Fotos e dados serão removidos automaticamente após este período
              </p>
            </div>
          </div>
        )}
